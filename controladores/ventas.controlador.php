...
static public function ctrCrearVenta(){
		...
		if ($_POST["nuevoEfecVent"] >= $_POST["nuevoTotalVenta"]) {
			
	/*================================================================================
	ACTUALIZAR LAS COMPRAS DEL CLIENTE Y REDUCIR EL STOCK Y AUNMENTAR LAS VENTAS DE LOS PRODUCTOS
	================================================================================*/

		$listaProductosV = json_decode($_POST["listaProductos"], true);
		
		$totalProductosComprados = array();

		foreach ($listaProductosV as $key => $value) {
		 ...
		 $tablaClientes = "clientes";
		  ...
		  $datos = array("id_vendedor" => $_POST["idVendedor"],
						 ...
						 "metodo_pago" => $_POST["MetodoPagos"],
						 "cambio" => $_POST["nuevoCambioVent"],
						 "importe" => $_POST["nuevoEfecVent"]);
		  ...
		  $respuesta = ModeloVentas::mdlIngresarVenta($tabla, $datos);
			...
			echo '<script>
				...
				Swal.fire({
				  ...
				  icon: "error",
				  title: "Oops...!",
				  text: "¡El total a pagar debe ser mayo o igual al precio total de venta.!",
					showConfirmButton: true,
					confirmButtonText: "Cerrar"
...
static public function ctrEliminarVenta(){
		...
		if (isset($_GET["idVenta"])) {
			...
			/*=========================================================
			=            ACTUALIZACION FECHA ÚLTIMA COMPRA           
			=========================================================*/
    ...
    static public function ctrEditarVenta(){
	    ...
	    if (isset($_POST["EditVenta"])) {
				...
				====================================================================*/
					...
					$nuevoStock_2 = ModeloProductos::mdlActualizarProducto($tablaProductos_2, $item1b_2, $valor1b_2, $valor_2);
					 ...
					 $tablaClientes_2 = "clientes";
					  ...
					  $traerCliente_2 = ModeloClientes::mdlMostrarClientes($tablaClientes_2, $item_2, $valorC_2);
		  ...
		  =========================================*/
		 		 ...
		 		 $datos = array("id_vendedor" => $_POST["idEditVendedor"],
								"id_cliente" => $_POST["seleccionarEditCliente"],
								"codigo" => $_POST["EditVenta"],
								"productos" => $listaProductos,
								"comentarios" => $_POST["Editcomentario"],
								"impuesto" => $_POST["nuevoPrecioDescuento"],
								"neto" => $_POST["nuevoPrecioNeto"],
