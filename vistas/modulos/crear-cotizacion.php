              ...
              <div class="row">
                ...
                <div class="col-lg-5 col-xs-12">
                    ...
                    <div class="input-group mb-3">
                     ...
                     <input type="text" class="form-control" id="nueVend" name="nueVend" value="<?php echo $_SESSION["nombre"]; ?>" readonly>
                ...
                <div class="col-lg-2 col-xs-12">
                   <label>Código de la cotización</label>
                    <div class="input-group mb-3">
                      ...
                      <div class="input-group-prepend">
                       ...
                       <?php  
                        ...
                        if(!$cotiz){
                          ...
                          echo'<input type="text" class="form-control" id="CodVent" name="CodVent" value="1001" readonly>';
                          ...
                          echo'<input type="text" class="form-control" id="CodVent" name="CodVent" value="'.$codigo.'" readonly>';
                ...
                <div class="col-lg-9 col-xs-12">
                   ...
                   <div class="input-group mb-3">
                      ...
                      <div class="input-group-prepend">
                       ...
                       <select class="form-control select2 select2-danger input-lg" data-dropdown-css-class="select2-danger" id="NuevCliente" name="NuevCliente" required>
              ...
              <div class="row">
                ...
                <div class="col-lg-8 col-xs-12">
                 ...
                 <h4 class="text-center">Comentarios de cotización</h4>
                  ...
                  <textarea id="summernote" class="form-control input-lg" rows="3" cols="20" name="NuevoComen" placeholder="Comentarios"></textarea>
                  ...
                  <table class="table table-condensed">
                    ...
                    <tbody>
                      ...
                      <td style="width:50%">
                        ...
                        <input type="number" class="form-control input-lg" min="0.25" step="any" id="nuevoDescuentoVenta" name="nuevoDescuentoVenta" placeholder="0">
                      ...
                      <td style="width:50%">
                        ...
                        <input type="text" class="form-control input-lg" id="nuevoTotalVen" name="nuevoTotalVen" total="" placeholder="0" required>
