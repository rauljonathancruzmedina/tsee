...
<div class="card card-primary card-outline">
    <div class="card-header">
      ...
      <div class="mailbox-controls float-right">
        ...
        <div class="btn-group">
          ...
          <button type="button" class="btn btn-outline-danger btn-sm btnPapelera" data-toggle="tooltip" title="Borrar" idTickets idUsuario="<?php echo $_SESSION["id"]; ?>" tipoTickets="papelera">
            <i class="far fa-trash-alt"></i>
          </button>

        </div>
        
        <a href="index.php?ruta=soporte&soporte=msg-recibidos"
    ...
    <div class="card-body">
      ...
      <input type="hidden" class="tipoMsj" value="recibidos" name="">
